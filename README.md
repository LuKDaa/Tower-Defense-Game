...
![Gameplay del juego Tower Defense](https://github.com/LuKDaa/Tower-Defense-Game/blob/main/assets/gamegif.gif?raw=true)
...
* **Máquina de Estados:** Un inicio de juego controlado ("Countdown", "Grace Period") para mejorar la experiencia de usuario.
* **Efectos y Sonido:** Incluye música de fondo, SFX para mejoras y una pantalla de Game Over completa.
